...
from tools.assertions.errors import ValidationErrorResponseSchema, ValidationErrorSchema, \
...
def assert_get_file_response(
    ...
    :return: Если данные пользователя не совпадают.
    """
...
def assert_get_file_with_incorrect_file_id_response(actual: ValidationErrorResponseSchema):
        """
         Функция для проверки валидационной ошибки при передаче некорректного file_id.

        :param actual: Фактический ответ от API.
        :raises AssertionError: Если фактический ответ не соответствует ожидаемой валидационной ошибке.
        """
